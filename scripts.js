...
const selectedCounter = document.querySelector('.sakai-table-actionsBar-selected > span');
const selectAllTableItems = exampleTable.querySelector('th.sakai-table-selectItem > input[type="checkbox"]');
const allTableItems = exampleTable.querySelectorAll('td.sakai-table-selectItem > input[type="checkbox"]');
const tableActionsClose = tableActions.querySelector('.sakai-table-actionsBar-cancel');
